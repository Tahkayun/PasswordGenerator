package ioscript.passwordgenerator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInterstitialAd.setAdUnitId(getString(R.string.admob_interst));
    ...
    public void initUI(){
        ...
        prefs = getSharedPreferences("ioscript.passwordgenerator", MODE_PRIVATE);
    }
